<?php
                            ...
                            $SQL1 = "SELECT count(*) as NumberofResident, round(monthlyincome,-1) as Income FROM resident group by monthly_income";
                            $SQL2 = "SELECT count(*) as NumberofResident,Zone FROM resident r group by r.purok";
                            $SQL3 = "SELECT COUNT( * ) as NumberofResident , Age FROM resident GROUP BY age";
