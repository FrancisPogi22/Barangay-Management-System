                        ...
                        <div class="tab-content">
                            <div id="walk-in" class="tab-pane fade">
                                ...
                                <table class="table table-bordered table-striped">
                                    ...
                                    <tbody>
                                        <?php
                                        $result = mysqli_query($con, "SELECT id, CONCAT(fname, ' ', mname, ' ', lname) AS completename, age, status FROM indigency_cert WHERE status='Walk-in'");
                            ...
                            <div class="modal-body">
                                <form id="certificateRequestForm" method="post" action="submit_indigency.php">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="year_stayed" name="year_stayed" style="width: 200px;" placeholder="Resident year" required>
                                    </div>
                ...
                <div id="editCertificateModal" class="modal fade" role="dialog">
                    <div class="modal-dialog" style="width: 400px;">
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form id="certificateRequestForm" method="post" action="edit_indigency.php">
