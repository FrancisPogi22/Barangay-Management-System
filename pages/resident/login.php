...
if (isset($_POST['btn_login'])) {
    ...
    $query = "SELECT * FROM tblsignup WHERE username='$username' AND password='$password' AND type='resident'";
    ...
    if ($num_rows > 0) {
        ...
        header('location: ../resident/clearance.php'); // Fixed the redirection path
        exit();
    } else {
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form role="form" method="post">
                        ...
                        <label id="error" class="label label-danger pull-right"><?php if (isset($error)) {
                                                                                    echo $error;
                                                                                }
                                                                                ?></label>
                        <br>
                        <center><a href="../resident/signup.php" style="color:red">Don't have an account? Sign up</a></center>
                        <center><a href="../absentee/login.php" style="color:green">Absentee Bussiness Owner? Click Here</a></center>
                    </form </div>
                </div>
            </div>
        </div>
