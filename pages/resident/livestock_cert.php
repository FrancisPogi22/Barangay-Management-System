...
if ($result->num_rows == 0) {
    header("Location: livestock_cert.php");
    exit;
}
                        ...
                        <div class="tab-content">
                            <div id="new" class="tab-pane fade in active">
                                ...
                                <table class="table table-bordered table-striped">
                                    ...
                                    <tbody>
                                        <?php
                                        $result = mysqli_query($con, "SELECT id, sellerName, sellerAddress, amount, buyerName, buyerAddress, itemSold, age, sex, cowlicks, brandMun, brandOwn, transacDate, status FROM livestock_cert WHERE status = 'New' AND sellerId = '{$_SESSION['userid']}'");
                            ...
                            <div id="approved" class="tab-pane fade">
                                ...
                                <table class="table table-bordered table-striped">
                                    ...
                                    <tbody>
                                        <?php
                                        $result = mysqli_query($con, "SELECT id, sellerName, sellerAddress, amount, buyerName, buyerAddress, itemSold, age, sex, cowlicks, brandMun, brandOwn, transacDate, status FROM livestock_cert WHERE status='Approved' AND sellerId = '{$_SESSION['userid']}'");
                                        while ($row = mysqli_fetch_array($result)) {
                                            echo "<tr>";
                                            echo "<td>" . $row['sellerName'] . "</td>";
                                            echo "<td>" . $row['sellerAddress'] . "</td>";
                            ...
                            <div id="disapproved" class="tab-pane fade">
                                ...
                                <table class="table table-bordered table-striped">
                                    ...
                                    <tbody>
                                        <?php
                                        $result = mysqli_query($con, "SELECT id, sellerName, sellerAddress, amount, buyerName, buyerAddress, itemSold, age, sex, cowlicks, brandMun, brandOwn, transacDate, status FROM livestock_cert WHERE status='Disapproved' AND sellerId = '{$_SESSION['userid']}'");
                                        while ($row = mysqli_fetch_array($result)) {
                                            echo "<tr>";
                                            echo "<td>" . $row['sellerName'] . "</td>";
                                            echo "<td>" . $row['sellerAddress'] . "</td>";
