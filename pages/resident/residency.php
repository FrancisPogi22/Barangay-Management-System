                        ...
                        <div class="tab-content">
                            <div id="new" class="tab-pane fade in active">
                                ...
                                <table class="table table-bordered table-striped">
                                    ...
                                    <tbody>
                                        <?php
                                        $result = mysqli_query($con, "SELECT id, CONCAT(fname, ' ', mname, ' ', lname) AS completename, age, bday, purok, year_stayed, status, pickup_date FROM residency_cert WHERE status='New' AND ownerId = {$_SESSION['userid']}");
                            ...
                            <div id="approved" class="tab-pane fade">
                                ...
                                <table class="table table-bordered table-striped">
                                    ...
                                    <tbody>
                                        <?php
                                        $result = mysqli_query($con, "SELECT id, CONCAT(fname, ' ', mname, ' ', lname) AS completename, age, bday, purok, year_stayed, status, pickup_date FROM residency_cert WHERE status='Approved' AND ownerId = {$_SESSION['userid']}");
                                        while ($row = mysqli_fetch_array($result)) {
                                            echo "<tr>";
                                            echo "<td>" . $row['completename'] . "</td>";
                                            echo "<td>" . $row['age'] . "</td>";
                            ...
                            <div id="disapproved" class="tab-pane fade">
                                ...
                                <table class="table table-bordered table-striped">
                                    ...
                                    <tbody>
                                        <?php
                                        $result = mysqli_query($con, "SELECT id, CONCAT(fname, ' ', mname, ' ', lname) AS completename, age, bday, purok, year_stayed, status, pickup_date FROM residency_cert WHERE status='Disapproved' AND ownerId = {$_SESSION['userid']}");
                                        while ($row = mysqli_fetch_array($result)) {
                                            echo "<tr>";
                                            echo "<td>" . $row['completename'] . "</td>";
                                            echo "<td>" . $row['age'] . "</td>";
                            ...
                            <div class="modal-body">
                                <form id="certificateRequestForm" method="post" action="submit_residency.php">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="date" class="form-control" id="pickup_date" name="pickup_date" style="width: 200px;" required>
                                    </div>
