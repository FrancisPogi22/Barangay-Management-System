        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title">Manage Barangay Police</h4>
                </div>
                        ...
                        <div class="container-fluid">
                            <div class="col-md-6 col-sm-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <input name="position" class="form-control input-sm input-size" type="text" placeholder="Position" />
                                </div>
                                <div class="form-group">
                                    <label class="control-label">Schedule:</label>
                                    <input name="sched" class="form-control input-sm input-size" type="date" placeholder="MM-DD-YYYY" />
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input name="address" class="form-control input-sm input-size" type="text" placeholder="Address" />
                                </div>
                                <div class="form-group">
