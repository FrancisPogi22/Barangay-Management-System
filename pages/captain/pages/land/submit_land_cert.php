...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $query = "INSERT INTO land_cert (sellerName, sellerAddress, buyerName, buyerAddress, landArea, propertySold,
    legalAgree, paymentConfirm, confirmationPay, date, witness, notarizeDate, locationNota, status) VALUES ('$sellerName', '$sellerAddress', 
