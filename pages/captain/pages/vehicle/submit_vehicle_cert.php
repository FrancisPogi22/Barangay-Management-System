...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $query = "INSERT INTO vehicle_cert (sellerName, sellerAddress, amount, buyerName, buyerAddress, make, 
    plateNum, engineNum, chasisNum, denomination, fuel, bodyType, crNo, date, witness, locationTran, status) VALUES ('$sellerName', '$sellerAddress', '$amount', 
