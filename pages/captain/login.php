...
if (isset($_POST['btn_login'])) {
    ...
    $query = "SELECT * FROM tblsignup WHERE username='$username' AND password='$password' AND type='captain'";
    ...
    if ($num_rows > 0) {
        ...
        header('location: pages/officials/officials.php'); // Fixed the redirection path
        exit();
    } else {
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form role="form" method="post">
                        ...
                        <br>
                        <center><a href="signup.php" style="color:red">Don't have an account? Sign up</a></center>
                    </form>
                </div>
            </div>
        </div>
