...
if (isset($_POST['btn_login'])) {
    ...
    $query = "SELECT * FROM tblsignup WHERE username='$username' AND password='$password' AND type='admin'";
    ...
    if ($num_rows > 0) {
        ...
        header('location: pages/dashboard/dashboard.php'); // Fixed the redirection path
        exit();
    } else {
